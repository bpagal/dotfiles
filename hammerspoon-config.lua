...
-- ### Super + 1  = open kitty
-- ### Super + 2  = open firefox
-- ### Super + 3  = open slack
-- ### Super + 4  = open 1password
-- ### Super + Q  = open joplin
-- ### Super + W  = open teams
-- ### Super + E  = open zoom
-- ### Super + A  = switch window instance
-- ### Super + S  = open brave browser
-- ### Super + Shift  + Tab  = move window to other monitor/screen

-- Define app bindings
bindAppHotkey("1", "kitty")
bindAppHotkey("2", "Firefox")
bindAppHotkey("3", "Slack")
bindAppHotkey("4", "1Password")

bindAppHotkey("Q", "Joplin")
bindAppHotkey("W", "Microsoft Teams")
bindAppHotkey("E", "zoom.us")

-- Super + A = switch window instance
bindAppHotkey("S", "Brave Browser")
